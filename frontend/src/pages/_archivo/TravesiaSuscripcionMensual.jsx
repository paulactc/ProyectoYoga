/* eslint-disable */
// ════════════════════════════════════════════════════════════════════════
// ARCHIVO — La Travesía (camino de 50 clases) + calendario/plan de práctica
//           + selector de métodos (Travesía / Explora a tu aire / Grupos)
// ────────────────────────────────────────────────────────────────────────
// Este fichero NO se importa desde ningún sitio de la app (no forma parte
// del bundle). Se guarda tal cual para reactivarlo el día que haya
// suficiente contenido grabado como para sostener la promesa de "La
// Travesía" (hoy ninguna de estas 50 clases tiene vídeo real) y/o la
// suscripción mensual.
//
// Contexto (2026-08-07): la web pivotó de "aula online + suscripción
// mensual" a "Pack Raíz" (10 clases, pago único) porque solo existían 7-10
// clases grabadas de verdad. Ver memoria del proyecto `project_pack_raiz`
// y `ClasesOnlinePage.jsx` (versión activa, mucho más simple).
//
// Para reactivar: mover este código de vuelta a ClasesOnlinePage.jsx,
// reconectar `vista` como máquina de estados (selector/travesia/filtros/
// grupos), y volver a montar las rutas backend de suscripción mensual
// (`/api/suscripcion`, ya presentes pero sin usar desde el frontend) y de
// progreso/plan de La Travesía (`/api/travesia/progress`, `/api/travesia/plan`).
// ════════════════════════════════════════════════════════════════════════
...
// GRUPOS duplicado aquí de ClasesOnlinePage.jsx para que este archivo sea autocontenido.
const GRUPOS = [
  {
    id: 1,
    tipo: 'vinyasa',
